  ...
  <h2 class="col-deep-purple"> LMCU STAFFS</h2>
      <ul class="header-dropdown m-r--5">
          <li class="dropdown">
              ...
              <span class="st-loader pull-right" style="position: absolute; right: 50px; top: 20px;">&nbsp;</span>
</div>
<div class="body">
  <style type="text/css">
    .add-button{
  ...
  <div class="add-button"><button type="button" class="btn btn-success btn-lg m-t-15 waves-effect" data-toggle="modal" data-target="#addOfficer"><i class="glyphicon glyphicon-plus"></i> Add Officer</button></div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p class="add_staff_log"></p>
                            <form id="add_staff_form" name="addOfficer" method="POST">
                 ...
                 <!--               <button class="btn btn-primary waves-effect" type="submit">SUBMIT</button> -->
                        ...
                        <div class="modal-footer bg-indigo">
                            <button type="button" class="btn btn-success waves-effect add-officer">SAVE CHANGES</button>
