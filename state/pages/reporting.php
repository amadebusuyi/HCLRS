           <div class="block-header">
            ...
            <div class="card report-stat hidden">
                <div class="header">
                    <h2 class="col-deep-orange"><b><span>Report Statistics</span><span class="rep-period pull-right"></span></b></h2>
                </div>
                <div class="body">
                    <div class="sort-div">
                        <button class="btn-default btn" onclick="toggleStat()">Back</button>
                        <div class="select-div">
                        <select class="report-select-lga form-control" name="repo-lga">
                        </select>
                        </div>
                    </div>
                    <div class="stat-display">
                        <p class="alert stat-total" style="text-align: center"></p>
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody class="fac-reported"></tbody>
                    </table>
                    </div>
                </div>
            </div>
            ...
            <div class="card report-stat-lga hidden">
                ...
                <div class="body">
                    <div class="sort-div">
                        <button class="btn-default btn" onclick="hideStatLGA()">Back</button>
                        <div class="select-div">
                        <select class="report-select-lga form-control" name="repo-lga">
                        </select>
                        </div>
